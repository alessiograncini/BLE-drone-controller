# Bluetooth API Documentation for Spectacles
...
**Important:** Bluetooth does not work in Lens Studio Preview. To properly test you will need to push to Spectacles.
...
The BLE API is Experimental. It is expected that some of the API may be constrained or may change in the future.
